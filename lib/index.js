...
function run(options, callback) {
    ...
    if (options.github) {
        ...
        var url = 'https://github.com/' + options.github + '/raw/master/' + options.file;
        ...
        var url = 'https://bitbucket.org/' + options.bitbucket + '/raw/master/' + options.file;
...
rend.heading = function(text, level) {
    ...
    if (this.settings.simple_headers) {
        full_text += indent;
    } else {
